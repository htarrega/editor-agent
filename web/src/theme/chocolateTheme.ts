...
/*
 * Sin `icons` a propósito. `astryx theme build` evalúa este archivo para
 * compilar los tokens a CSS estático, y no sabe transpilar el JSX del
 * registro de iconos ("React is not defined"). El registro se engancha en
 * main.tsx sobre el tema ya construido, que es donde vive el runtime.
 */
...
export const chocolateTheme = defineTheme({
  ...
  tokens: {
    ...
    '--color-text-secondary': ['#8A6440', '#c4a882'],
    ...
    '--color-icon-secondary': ['#8A6440', '#c4a882'],
